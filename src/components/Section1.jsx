    ...
    <div className="section1 min-h-[70vh] flex flex-col lg:flex-row p-4 max-w-7xl mx-auto w-full">
      <div className="left flex-1 flex items-center justify-center lg:pr-4">
        <div className="text-center lg:text-left">
          <h1 className='text-5xl font-bold my-5'>Landing Page <br />inspired by Printify</h1>
          <ul className='p-5 flex flex-col gap-3 font-medium'>
            ...
            <li className='flex items-center gap-2'><Check className='text-green-500' /> Made using React and Tailwind</li>
            <li className='flex items-center gap-2'><Check className='text-green-500' /> Deployed on Vercel</li>
          </ul>
